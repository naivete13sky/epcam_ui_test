...
class TestCopyFeature:
    ...
    @pytest.mark.crash
    @pytest.mark.parametrize("job_id", GetTestData.get_job_id('Copy_Feature_Crash'))
    def test_graphic_copy_feature_case_4717(self, job_id, epcam_ui_start,
                                                 download_file_compressed_entity_filter_delete_all_jobs_import):
        """
        验证右侧工具栏的copy功能，全选后删除，双击闪退
        禅道BUG：3836
        禅道用例：4717
        :param job_id:44814
