...
class PageDcodeEdit(object):
    def __init__(self):
        self.engineering_input_dcode_edit_window = RunConfig.driver_epcam_ui.window(
            **page.engineering_file_input_dcode_edit_window_para)


    def close(self):
        self.engineering_input_dcode_edit_window.click_input(
            coords=page.engineering_file_input_dcode_edit_close_coord)
    ...
    def is_right(self):
        ...
        img = cv2.imread(r'C:\cc\share\temp\dcode_edit_window.png')
