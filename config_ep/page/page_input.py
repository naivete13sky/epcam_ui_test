...
class PageInput(object):
    def __init__(self):
        ...
        self.engineering_input_clear_right_click_menu_window = None
        # 点击菜单File(F)--import
    ...
    def clear(self):
        ...
        self.engineering_input_clear_right_click_menu_window = RunConfig.driver_epcam_ui.window(
            **page.engineering_file_input_file_right_click_menu_window_para)
        self.engineering_input_clear_right_click_menu_window.click_input(
